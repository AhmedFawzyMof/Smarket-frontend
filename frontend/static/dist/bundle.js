  ...
  var e = /*#__PURE__*/ (function (_t4) {
                  ...
                  while (1)
                    switch ((_context4.prev = _context4.next)) {
                      ...
                      case 21:
                        ...
                        return _context4.delegateYield(_loop2(), "t1", 23);
                      case 23:
                        _v++;
                        _context4.next = 21;
                        break;
          ...
          value: (function () {
            var _getHtml4 = _asyncToGenerator(
              /*#__PURE__*/ _regeneratorRuntime().mark(function _callee4() {
                var _t8, _e4, n, _a, _t9, _e5, _t10, _a2, i;
                return _regeneratorRuntime().wrap(
                      ...
                      switch ((_context6.prev = _context6.next)) {
                        ...
                        case 12:
                          for (_t9 = 0; _t9 < _a.length; _t9++) {
                            ...
                            for (_t10 = 0; _t10 < n.length; _t10++) {
                              _a2 = n[_t10];
                              _e5.id === _a2.order && _e5.cart.push(_a2);
                            }
                          }
                          _e4.Error &&
                            (localStorage.removeItem("AuthToken"),
                          ...
                          i = _a.map(function (t, e) {
                            ...
                            return '\n          <div class="orderRec" key="'
                              ...
                              .concat(
                                0 == t.confirmed
                                  ? '\n              <button class="cancel_order" onclick="CancelOrder(\''
                                      .concat(t.id, "', ")
                                      .concat(
                                        t.confirmed,
                                        ')">\u0627\u0644\u063A\u0627\u0621 \u0627\u0644\u0637\u0644\u0628</button>\n              '
    ...
    i = /*#__PURE__*/ (function (_t11) {
      ...
      function i(t, e) {
        ...
        (_this4.productId = n),
          _this4.setTitle("Product: " + _this4.productId),
          _this4.setStyle("/static/css/product.css");
        return _this4;
      }
      _createClass(i, [
        {
                    ...
                    while (1)
                      switch ((_context7.prev = _context7.next)) {
                        case 0:
                          ...
                          _context7.next = 3;
                          return fetch(
                            "https://smarket-api-5o9n.onrender.com/product/" +
                              this.productId
                          );
                        case 3:
                          t = _context7.sent;
                        ...
                        case 6:
                          ...
                          n = "";
                          for (_t12 = 0; _t12 < parseInt(e.inStock); _t12++)
                            n += '<option value="'
                              .concat(_t12 + 1, '">')
                              .concat(_t12 + 1, "</option>");
                          a =
                            "\n    <div class='image'>\n      <img src='/static"
                              .concat(
                                e.image,
                              ...
                              .concat(e.company, "' data-link class='seemore'>")
                              .concat(
                                e.company,
                                "</a></p>\n        <div class='prices'>\n          "
                              )
    ...
    s = /*#__PURE__*/ (function (_t13) {
      ...
      function s(t, e) {
        ...
        (_this5.company = n),
          _this5.setTitle(n),
          _this5.setStyle("/static/css/company.css");
        return _this5;
      }
      _createClass(s, [
        {
                    ...
                    while (1)
                      switch ((_context8.prev = _context8.next)) {
                        case 0:
                          ...
                          _context8.next = 3;
                          return fetch(
                            "https://smarket-api-5o9n.onrender.com/company/" +
                              this.company
                          );
                        case 3:
                          t = _context8.sent;
                          ...
                          return t.json();
                        case 6:
                          e = _context8.sent.Products.map(function (t, e) {
                    ...
                    while (1)
                      switch ((_context9.prev = _context9.next)) {
                        case 0:
                          ...
                          _context9.next = 3;
                          return fetch(
                            "https://smarket-api-5o9n.onrender.com/category/" +
                              this.category
                          );
                        case 3:
                          t = _context9.sent;
                          ...
                          return t.json();
                        case 6:
                          e = _context9.sent.Products.map(function (t, e) {
                            var n = t.name.substr(0, 20);
                            return "\n      <div class='"
                              .concat(
                                (function () {
    ...
    l = /*#__PURE__*/ (function (_t19) {
      ...
      function l(t, e) {
        ...
        (_this10 = _super10.call(this, t, e)),
          (_this10.auth = e),
          _this10.setTitle("my Favourite"),
          _this10.setStyle("/static/css/company.css");
        return _this10;
      }
      _createClass(l, [
        {
    ...
    u = /*#__PURE__*/ (function (_t22) {
      ...
      function u(t, e) {
        ...
        (_this11 = _super11.call(this, t, e)),
          (_this11.auth = e),
          _this11.setTitle("Chose Method"),
          _this11.setStyle("/static/css/orderMethod.css");
        return _this11;
      }
      _createClass(u, [
        {
    ...
    p = /*#__PURE__*/ (function (_t23) {
      ...
      function p(t, e) {
        ...
        (_this12 = _super12.call(this, t, e)),
          (_this12.method = t.method),
          (_this12.auth = e),
          _this12.setTitle("Orders"),
          _this12.setStyle("/static/css/Order.css");
        return _this12;
      }
      _createClass(p, [
        {
    ...
    h = /*#__PURE__*/ (function (_t24) {
      ...
      function h(t, e) {
        ...
        (_this13 = _super13.call(this, t, e)),
          (_this13.auth = e),
          _this13.setTitle("Chose Method"),
          _this13.setStyle("/static/css/orderMethod.css");
        return _this13;
      }
      _createClass(h, [
        {
          key: "getHtml",
          value: (function () {
            var _getHtml14 = _asyncToGenerator(
    ...
    m = /*#__PURE__*/ (function (_t25) {
      ...
      function m(t, e) {
        ...
        (_this14 = _super14.call(this, t, e)),
          (_this14.auth = e),
          _this14.setTitle("Chose Method"),
          _this14.setStyle("/static/css/company.css");
        return _this14;
      }
      _createClass(m, [
        {
