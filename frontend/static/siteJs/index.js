...
function Scroll() {
  ...
  num++;
  var dot = document.getElementById("d" + num);
  if (dot !== null) {
...
function getProductsInCart() {
  ...
  Products.forEach(function (Product) {
    var Id = parseInt(Product.attributes.id.value);
...
function replaceBtns(products) {
  products.forEach(function (product) {
    ...
    if (p !== null) {
      ...
      fav.style.top = "100px";
      var quantityDiv = p.querySelector("#Quantity");
...
function incQuantity(productId) {
  var res = Cart.find(function (item, index) {
    Object.assign(item, {
      index: index,
    });
...
function addToFav(_x) {
  return _addToFav.apply(this, arguments);
}
function _addToFav() {
  _addToFav = _asyncToGenerator(
        ...
        while (1)
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              _context.next = 3;
              return fetch("https://smarket-api-5o9n.onrender.com/fav/add", {
                method: "post",
                body: JSON.stringify({
                  product: productId,
